...
| --- | ---: | ---: | ---: |
| PyTorch FID ↓ | 15.8674 | 15.7770 | -0.0904 |
| R-precision ↑ | 77.57% ± 0.47% | 77.55% ± 0.58% | -0.03 pp |
| ImageNet IS ↑ | 5.6158 | 5.6197 | 0.0039 |

## Paired R-precision evidence

- Baseline-only correct: 379
- DM-GAN + CL2-only correct: 371
- Exact McNemar p-value: 0.798277
